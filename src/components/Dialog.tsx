        ...
        <Dialog>
            ...
            <DialogContent className="sm:max-w-[425px]">
                ...
                <div className="grid gap-4 py-4">
                    ...
                    {sequence.length > 0 && <p className="text-primary">Your seat numbers are:</p>}
                    {sequence.length > 1 && (
                        <textarea
                            className="w-full border max-h-[2rem] outline-none"
                            value={sequence.join(", ")}
                            readOnly
                        />
                    )}
                ...
                <DialogFooter>
                    <Button onClick={seatBooking} className="bg-primary hover:bg-primaryhover" type="submit">
                        Book Seat
                    </Button>
                </DialogFooter>
            </DialogContent>
